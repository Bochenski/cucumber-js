var Library = function(supportCodeDefinition) {
  ...
  var self = {
    ...
    afterAllHooksFunction: function afterAllHooksFunction(world) {
      var triggerFunction = function(callback) {
    ...
    defineAfterAllHook: function defineAfterAllHook() {
      var tagGroupStrings = Cucumber.Util.Arguments(arguments);
      var code           = tagGroupStrings.pop();
      hooker.addAfterAllHookCode(code, {tags: tagGroupStrings});
    },
  ...
  var supportCodeHelper = {
    ...
    AfterAll   : self.defineAfterAllHook,
